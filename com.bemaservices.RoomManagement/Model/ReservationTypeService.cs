...
namespace com.bemaservices.RoomManagement.Model
{
    ...
    /// Implements the <see cref="Rock.Data.Service{com.bemaservices.RoomManagement.Model.ReservationType}" />
    /// </summary>
    /// <seealso cref="Rock.Data.Service{com.bemaservices.RoomManagement.Model.ReservationType}" />
    public class ReservationTypeService : Service<ReservationType>
    {
        ...
        /// <returns><c>true</c> if [is person in group with identifier] [the specified person]; otherwise, <c>false</c>.</returns>
        ...
        /// <returns><c>true</c> if [is person in group with unique identifier] [the specified person]; otherwise, <c>false</c>.</returns>
