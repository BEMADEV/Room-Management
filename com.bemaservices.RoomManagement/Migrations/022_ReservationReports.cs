...
namespace com.bemaservices.RoomManagement.Migrations
{
    ...
    public class ReservationReports : RoomManagementMigration
    {
        /// <summary>
        ...
        {
            RoomManagementMigrationHelper.UpdateFieldTypeByGuid( "Report Template", "", "com.bemaservices.RoomManagement", "com.bemaservices.RoomManagement.Field.Types.ReportTemplateFieldType", "6B88A513-4B4C-403B-ADFA-82C3A2B1C3B8" );

            var isExistingUser = RoomManagementMigrationHelper.IsExistingUser( 22 );
            if ( !isExistingUser )
            {
                ...
                var defaultFont = RoomManagementMigrationHelper.GetAttributeValueFromBlock( blockId, "B9DA1FF2-10EA-4466-BD67-A4D62E03D703".AsGuid() );
                var defaultLogo = RoomManagementMigrationHelper.GetAttributeValueFromBlock( blockId, "C05E0362-6C49-4D59-8DB7-7DCADAF19FDD".AsGuid() );
                var selectedReportTemplateGuid = RoomManagementMigrationHelper.GetAttributeValueFromBlock( blockId, "8E2EE6F2-54FC-4C3A-9C9A-54CEA34544F7".AsGuid() );
                var defaultLava = RoomManagementMigrationHelper.GetAttributeValueFromBlock( blockId, "69131013-4E48-468E-B2C2-CF19CEA26590".AsGuid() );

                var lavaTemplate = RoomManagementMigrationHelper.GetAttributeValueFromBlock( blockId, "52C3F839-A092-441F-B3F9-10617BE391EC".AsGuid() );
