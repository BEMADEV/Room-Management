...
namespace com.bemaservices.RoomManagement.Migrations
{
    ...
    public class ReservationLocationTypes : RoomManagementMigration
    {
        /// <summary>
...
" );
            RoomManagementMigrationHelper.UpdateEntityTypeByGuid( "com.bemaservices.RoomManagement.Model.ReservationLocationType", "Reservation Location Type", "com.bemaservices.RoomManagement.Model.ReservationLocationType, com.bemaservices.RoomManagement, Version=1.2.2.0, Culture=neutral, PublicKeyToken=null", true, true, "834F278F-49E6-4BEA-B724-E7723F9EE4C9" );
...
Outer Apply DefinedValue dv where dv.DefinedTypeId = (Select Top 1 Id From DefinedType Where Guid = '3285DCEF-FAA4-43B9-9338-983F4A384ABA')" );
            RoomManagementMigrationHelper.UpdateEntityTypeByGuid( "com.bemaservices.RoomManagement.Workflow.Actions.Reservations.SetReservationApprovalState", "3894452A-E763-41AC-8260-10373646D8A0", false, true );

            var isExistingUser = RoomManagementMigrationHelper.IsExistingUser( 29 );
            if ( !isExistingUser )
            {
                #region EntityTypes
