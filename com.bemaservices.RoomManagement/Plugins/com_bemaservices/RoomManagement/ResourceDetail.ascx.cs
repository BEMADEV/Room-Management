    ...
    public partial class ResourceDetail : RockBlock, IDetailBlock
    {
        ...
        private void SaveResource()
        {
            if ( Page.IsValid )
            {
                ...
                if ( resource.PhotoId != fuPhoto.BinaryFileId )
                {
                    orphanedPhotoId = resource.PhotoId;
                    resource.PhotoId = fuPhoto.BinaryFileId;
                ...
                rockContext.WrapTransaction( () =>
                {
                    ...
                    if ( resource.PhotoId.HasValue )
                    {
                        var binaryFile = binaryFileService.Get( resource.PhotoId.Value );
        ...
        public void ShowDetail( int resourceId, bool resetCampus = true )
        {
            ...
            cbIsActive.Checked = resource.IsActive;
            ...
            fuPhoto.BinaryFileId = resource.PhotoId;
