...
namespace com.bemaservices.RoomManagement.Migrations
{
    ...
    public class NewBlockSettings : RoomManagementMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            try
            {
                ...
                Sql( @"SELECT COUNT (1) FROM [dbo].[_com_bemaservices_RoomManagement_Reservation] WHERE [EventContactPersonAliasId] <> NULL" );
            }
            catch ( Exception )
            {
                Sql( @"
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] DROP CONSTRAINT [FK__com_bemaservices_RoomManagement_Reservation_ContactPersonAliasId]
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] DROP COLUMN [ContactPersonAliasId]
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] DROP COLUMN [ContactPhone]
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] DROP COLUMN [ContactEmail]

                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [EventContactPersonAliasId] INT
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [EventContactPhone] NVARCHAR (50)
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [EventContactEmail] NVARCHAR (400)

                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] WITH CHECK ADD CONSTRAINT [FK__com_bemaservices_RoomManagement_Reservation_EventContactPersonAliasId] FOREIGN KEY([EventContactPersonAliasId])
                REFERENCES [dbo].[PersonAlias] ([Id])
                " );

                Sql( @"
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [AdministrativeContactPersonAliasId] INT
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [AdministrativeContactPhone] NVARCHAR (50)
                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] ADD [AdministrativeContactEmail] NVARCHAR (400)

                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Reservation] WITH CHECK ADD CONSTRAINT [FK__com_bemaservices_RoomManagement_Reservation_AdministrativeContactPersonAliasId] FOREIGN KEY([AdministrativeContactPersonAliasId])
                REFERENCES [dbo].[PersonAlias] ([Id])
                " );
            }
            ...
            var isExistingUser = RoomManagementMigrationHelper.IsExistingUser( 11 );
            if ( !isExistingUser )
            {
                ...
                RockMigrationHelper.UpdateAttributeQualifier( "5A6A4F0F-EB7C-4A69-B97F-4FD47DB80F44", "ispassword", @"False", "B9E64655-C3E6-4637-8D0D-E12E313BAA08" ); // Room Reservation Reminder Notification:Email To:ispassword
...
{{ 'Global' | Attribute:'EmailFooter' }}
            " ); // Room Reservation Reminder Notification:Start:Send Email:Body
                ...
                RoomManagementMigrationHelper.UpdateEntityAttributeByGuid( "Rock.Model.ServiceJob", "55810BC5-45EA-4044-B783-0CCE0A445C6F", "Class", "com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange", "Date Range", "The range of reservations to fire a workflow for.", 0, @",", "8F3BEC15-A076-4C07-8047-D85C319F8DBF", "DateRange" );

                RoomManagementMigrationHelper.UpdateEntityAttributeByGuid( "Rock.Model.ServiceJob", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Class", "com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange", "Include only reservations that start in date range", "", 0, @"False", "3E394836-2175-4C5B-9247-063BCB6CD6D2", "StartsInDateRange" );
                ...
                RoomManagementMigrationHelper.UpdateEntityAttributeByGuid( "Rock.Model.ServiceJob", "BD0D9B57-2A41-4490-89FF-F01DAB7D4904", "Class", "com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange", "Reservation Statuses", "The reservation statuses to filter by", 0, @"", "49D7EDB4-E2FB-4081-B4D5-43D8217BF105", "Status" );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteAttribute( "8F3BEC15-A076-4C07-8047-D85C319F8DBF" ); // com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange: Date Range
            RockMigrationHelper.DeleteAttribute( "3E394836-2175-4C5B-9247-063BCB6CD6D2" ); // com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange: Include only reservations that start in date range
            RockMigrationHelper.DeleteAttribute( "E14B7BA0-77D8-4553-B2E0-070FF3ECA34E" ); // com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange: Workflow Type
            RockMigrationHelper.DeleteAttribute( "49D7EDB4-E2FB-4081-B4D5-43D8217BF105" ); // com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange: Reservation Statuses

            // remove ServiceJob: Reservation Reminder
            Sql( @"IF EXISTS( SELECT [Id] FROM [ServiceJob] WHERE [Class] = 'com.bemaservices.RoomManagement.Jobs.FireWorkflowFromReservationInDateRange' AND [Guid] = '6832E24B-5650-41D3-9EBA-1D2D213F768C' )
            BEGIN
