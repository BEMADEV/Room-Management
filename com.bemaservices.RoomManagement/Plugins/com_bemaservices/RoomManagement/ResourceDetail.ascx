<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResourceDetail.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.ResourceDetail" %>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <Rock:DataTextBox ID="tbName" runat="server" Label="Name" Required="true" SourceTypeName="com.bemaservices.RoomManagement.Model.Resource, com.bemaservices.RoomManagement" PropertyName="Name" />
                        </div>
                        <div class="col-md-3">
                            <Rock:RockCheckBox ID="cbIsActive" runat="server" Label="Is Active?" />
                        </div>
                        <div class="col-md-3">
                            <Rock:CategoryPicker ID="cpCategory" runat="server" Label="Category" EntityTypeName="com.bemaservices.RoomManagement.Model.Resource" Required="true" />
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <Rock:FileUploader ID="fuPhoto" runat="server" Label="Photo" />
                        </div>
                    </div>

                    <Rock:DataTextBox ID="tbNote" runat="server" Label="Note" TextMode="MultiLine" Rows="4" SourceTypeName="com.bemaservices.RoomManagement.Model.Resource, com.bemaservices.RoomManagement" PropertyName="Note" />
